...
public class RocketShip : MonoBehaviour {
	...
	public void FireThruster(){
		...
		//acceleration = transform.forward * thrustSpeed;
		// print (angle);
		//acceleration.y = acceleration.y + (thrustSpeed * (Mathf.Sin (angle)));
		//acceleration.x = acceleration.x + (thrustSpeed * (Mathf.Cos (angle)));
